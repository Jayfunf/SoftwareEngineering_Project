...
public class search_Activity extends AppCompatActivity {
    ...
    public float[][] mophs(String strText){
        String [] word_dict = {",", "이", "다", "하", "가", "ㄴ다", "의", "두통", "ㅁ", "는", "에", "ㄴ", "소화", ".", "증상", "염증", "통증", "피부", "코", "을", "머리", "구토", "및", "등", "고", "과", "·", "감", "알레르기", "통", "비염", "염", "멀미", "의하", "속", "어요", "불량", "팽만", "구역", "낳", "콧물", "재채기", "인후", "막히", "감기", "기침", "아프", "있", "은", "지", "발생", "가려움", "발진", "열", "오한", "근육통", "아", "어지럽", "속이", "안", "싶", "ㄹ", "같", "ㅂ니다", "되", "거나", "에서", "었", "유발", "완화", "인하", "복부", "성", "가렵", "두드러기", "위염", "약", "막", "힘", "발열", "관절통", "급성", "나오", "편두통", "편도", "선염", "운동", "후", "쑤시", "좋", "부", "를", "느끼", "오심", "창백", "변화", "위장관", "이나", "졸립", "복통", "고열", "곤란", "면", "나요", "다음", "질환", ":", "체", "개선", "약물", "로", "지연", "트림", "결막염", "부위", "쓰리", "또는", "습진", "여드름", "기미", "주근깨", "위산", "위부", "춥", "떨리", "목구멍", "목감기", "가래", "독감", "자주", "긴장성", "혈관성", "신경통", "유선염", "요통", "관절", "종", "이하", "근골", "피로", "사지", "산통", "신경성", "지근", "지근지근", "쑤", "시", "매스껍", "더", "륵", "하다", "토하", "때", "단순히", "어지럼증", "뿐", "아니", "라", "식은땀", "입", "마름", "심박수", "혈압", "증가", "와", "감소", "자율", "신경", "교란", "함께", "경험", "경우", "도", "많", "일반적", "메스껍", "막연", "미식", "거림", "덧붙이", "어서", "무기력", "침", "흘리", "것", "발한", "한숨", "하품", "맥박", "수의", "동반", "목", "따", "움", "미열", "연하", "호흡", "상기도", "감염", "뒷머리", "묵직", "콕콕", "전체", "멍하", "게", "흔히", "보이", "안구", "긴장형", "나타나", "않", "생기", "는데요", "가라앉", "없애", "살균", "치은염", "구내염", "발", "전후", "염증성", "부종", "수술", "외상", "유즙", "울", "가벼운", "절상", "찰과상", "화상", "으로", "감염증", "예방", "인간", "사용", "효소", "보충", "어", "주", "약품", "들", "시키", "잘", "에요", "안되", "거", "아요", "간기능", "저하", "보조", "치료", "(", ")", "식욕", "감퇴", "쓰", "리다", "신물", "올라오", "아리", "부비동", "급만", "혈관", "운동성", "반응", "알", "러", "봄철", "각막염", "눈물", "눈", "발적", "부어오르", "건조", "걸리", "명치", "갑작스럽", "증과", "상복", "동통", "식후", "심와", "부의", "그득", "함", "조기", "수", "습니다", "질병", "그", "밖", "상해", "아픔", "사람", "동물", "못하", "도록", "심하", "뭐", "나", "물집", "잡히", "햇볕", "탄", "색소", "침착증", "전신", "권태", "피부염", "과다", "불쾌감", "위통", "신트림", "몸살기", "운", "몸", "열이", "많이", "고온", "높", "감기약", "두통약", "멀미약", "소염제", "소화제", "진통제", "피부약", "해열제", "소", "진통"};
